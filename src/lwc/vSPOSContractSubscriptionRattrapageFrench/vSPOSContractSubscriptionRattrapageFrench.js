...
import { OMNIDEF } from './vSPOSContractSubscriptionRattrapageFrench_def.js';
import tmpl from './vSPOSContractSubscriptionRattrapageFrench.html';
import tmpl_nds from './vSPOSContractSubscriptionRattrapageFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vSPOSContractSubscriptionRattrapageFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
