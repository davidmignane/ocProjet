...
import { OMNIDEF } from './vSPOS02ContractSubscriptionFrench_def.js';
import tmpl from './vSPOS02ContractSubscriptionFrench.html';
import tmpl_nds from './vSPOS02ContractSubscriptionFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vSPOS02ContractSubscriptionFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
