...
import { OMNIDEF } from './vSPOS03ContractSubscriptionOffreMobileFrench_def.js';
import tmpl from './vSPOS03ContractSubscriptionOffreMobileFrench.html';
import tmpl_nds from './vSPOS03ContractSubscriptionOffreMobileFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vSPOS03ContractSubscriptionOffreMobileFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
